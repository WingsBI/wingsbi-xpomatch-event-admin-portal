          ...
          <Box sx={{ p: 2 }}>
            ...
            <Box display="flex" flexWrap="wrap" gap={4}>
              <Box minWidth={320}>
                ...
                <Typography variant="body2"><b>Job Title:</b> {visitor.userProfile?.jobTitle || '-'}</Typography>
                <Typography variant="body2"><b>Designation:</b> {visitor.userProfile?.designation || '-'}</Typography>
                <Typography variant="body2"><b>Company Name:</b> {visitor.userProfile?.companyName || '-'}</Typography>
